...
/**
 * 代码改自{@link Cache}，改造{@link Cache#key(HttpUrl)}函数
 */
public final class FormatCache implements Closeable, Flushable {
    ...
    final InternalCache internalCache = new InternalCache() {
        ...
        public Response get(Request request) throws IOException {
            return FormatCache.this.get(request);
        }

        @Override
        public CacheRequest put(Response response) throws IOException {
            return FormatCache.this.put(response);
        }

        @Override
        public void remove(Request request) throws IOException {
            FormatCache.this.remove(request);
        }

        @Override
        public void update(Response cached, Response network) {
            FormatCache.this.update(cached, network);
        }

        @Override
        public void trackConditionalCacheHit() {
            FormatCache.this.trackConditionalCacheHit();
        }

        @Override
        public void trackResponse(CacheStrategy cacheStrategy) {
            FormatCache.this.trackResponse(cacheStrategy);
        }
    };
    ...
    public FormatCache(File directory, long maxSize, KeyFormatter formatter) {
        this(directory, maxSize, FileSystem.SYSTEM, formatter);
    }

    FormatCache(File directory, long maxSize, FileSystem fileSystem, KeyFormatter formatter) {
